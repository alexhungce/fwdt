...
static DEVICE_ATTR(acpi_method_0_1, S_IRUGO | S_IWUSR, acpi_method_0_1_read, acpi_method_name_write);
...
static DEVICE_ATTR(acpi_method_2_1, S_IRUGO | S_IWUSR, acpi_method_2_1_read, acpi_method_name_write);
