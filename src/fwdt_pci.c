...
ssize_t pci_write_data(struct device *dev,
...
ssize_t pci_read_offset(struct device *dev,
	struct device_attribute *attr, char *buf)
{
	return sprintf(buf, "%x\n", pci_dev.offset);
}

ssize_t pci_write_offset(struct device *dev,
	struct device_attribute *attr, const char *buf, size_t count)
{
...
ssize_t pci_read_ids(struct device *dev,
	struct device_attribute *attr, char *buf)
{
...
ssize_t pci_write_ids(struct device *dev,
	struct device_attribute *attr, const char *buf, size_t count)
{
